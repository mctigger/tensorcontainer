...
class TestTensorRelaxedBernoulliAPIMatch:
    ...
    def test_compile_compatibility(self, shape):
        ...
        td_relaxed_bernoulli = TensorRelaxedBernoulli(temperature=temperature, probs=probs)
    ...
    def test_property_values_match(self, shape):
        ...
        assert td_relaxed_bernoulli.logits.allclose(RelaxedBernoulli(temperature=temperature, probs=probs).logits)